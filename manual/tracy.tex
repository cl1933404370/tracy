...
\item \emph{\faNoteSticky{}~Set from annotation} -- Allows using the annotation region for limiting purposes.
\item \emph{\faArrowUpWideShort{}~Copy from statistics} -- Copies the statistics time range limit.
\item \emph{\faMagnifyingGlass{}~Copy from find zone} -- Copies the find zone time range limit.
